...
export const mockUsers = {
  'neymarjr': { name: 'neymarjr', bio: 'Bio of neymarjr', avatarUrl: neymarjrImage, posts: [mockPosts[0], mockPosts[3]] },
  'ochicoin': { name: 'ochicoin', bio: 'Bio of ochicoin', avatarUrl: ochicoinImage, posts: [mockPosts[1], mockPosts[4]] },
  'casimiro': { name: 'casimiro', bio: 'Bio of casimiro', avatarUrl: casimiroImage, posts: [mockPosts[2], mockPosts[5]] },
};
